...
2. The script must always be called using `start cmd /c "tarrer.bat"` to avoid using the set variables that might in extreme case interfere with the correct file name.
