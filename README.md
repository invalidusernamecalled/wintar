...
2. The script must always be called using `start cmd /c "tarrer.bat"` to avoid using the already set variables that might in an extreme case interfere with the correct file name.
